        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Mis videos</h4>
                </div>
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        ...
                        <button type="button" @click="abrirModal()" class="btn btn-info d-lg-block m-l-15" v-b-tooltip.hover title="Agregar video a mi perfil"><i class="fa fa-plus-circle"></i> Agregar video</button>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="table-responsive">
                                        <b-container fluid>
                                            ...
                                            <template slot="acciones" slot-scope="row">
                                                <template>
                                                    <b-button size="xs" v-b-tooltip.hover title="Eliminar video" @click="borrar(row.item.id)" class="btn btn-danger">
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myLargeModalLabel">Agregar video</h4>
                                ...
                                <form class="form">
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" v-model="video.titulo" placeholder="Título de aviso" name="Titulo" v-validate.continues="'required|alpha_spaces'" data-vv-scope="modal">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <label for="">Vídeo</label>
                                            <b-form-file id="video" name="video"
                                                v-model="video.url"
                                                accept="video/*"
                        ...
                        <div class="modal-footer">
                            <button type="button" @click="subirVideo()" class="btn btn-info">Agregar</button>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            listarVideos (){
                let me=this;
                axios.get('/videos/usuario').then(function (response) {
            ...
            subirVideo(){
                this.$validator.validateAll('modal').then(valido => {
                    if (valido) {
                        ...
                        axios.post('/video/crear/usuario',formData).then(function (response) {
                            me.listarVideos();
                            me.cerrarModal();                            
                            swal.fire(
                                'Video agregado con éxito',
