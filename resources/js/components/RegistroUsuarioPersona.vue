                    ...
                    <form class="contact-form row columns_padding_10 columns_margin_bottom_10">
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <div class="contact-form-submit topmargin_20">
                                <button type="button" id="contact_form_submit" @click="registro()" class="theme_button color2">Registrarme</button>
...
<script>
    export default {
        ...
        methods:{
            ...
            registro(){
                this.$validator.validateAll('registro_usuario_persona').then(valido => {
                    if (valido) {
                        let me = this;
                        me.errors.clear();
                        axios.post('/register',{
