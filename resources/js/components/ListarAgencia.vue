<template>
    <section v-show="usuarios.length > 0" id="agencia" class="ds section_padding_100 container_padding_60 bottompadding_10">
...
<script>
    export default {
        ...
        methods:{
            listarUsuarios (){
                let me=this;
                axios.get('/usuarios/agencia/' + this.ciudad).then(function (response) {
